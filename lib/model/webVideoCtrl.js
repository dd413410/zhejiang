        ...
        var _ = function() {
          ...
          se = function(e) {
            var t = location.hostname,
              n = location.port || "80";
            return /^(http|https):\/\/([^\/]+)(.+)$/.test(e) && (e = e.replace(RegExp.$2, t + ":" + n)), f.cookie("webVideoCtrlProxy", RegExp.$2, {
              raw: !0
            }), e
          },
          oe = function() {
        ...
        this.I_EnableEZoom = function(e) {
          ...
          if(f.extend(p, t), -1 != r) {
            ...
            if(f.extend(p, {
              ...
              if(re()) p.szStartTime = p.szStartTime.replace(" ", "T") + "Z", p.szEndTime = p.szEndTime.replace(" ", "T") + "Z", P.oProtocolInc.startPlayback(P, p).then(function() {
                t.success && t.success()
              }, function() {
                t.error && t.error()
              });
            ...
            function(e) {
              ...
              for(e[r >> 5] |= 128 << 24 - r % 32, e[(r + 64 >> 9 << 4) + 15] = r, p = 0; p < e.length; p += 16) {
                for(s = m[0], o = m[1], i = m[2], a = m[3], c = m[4], u = m[5], l = m[6], d = m[7], P = 0; 64 > P; P++) C[P] = 16 > P ? e[P + p] : t(t(t(n(C[P - 2], 17) ^ n(C[P - 2], 19) ^ C[P - 2] >>> 10, C[P - 7]), n(C[P - 15], 7) ^ n(C[P - 15], 18) ^ C[P - 15] >>> 3), C[P - 16]),
                  h = t(t(t(t(d, n(c, 6) ^ n(c, 11) ^ n(c, 25)), c & u ^ ~c & l), f[P]), C[P]), I = t(n(s, 2) ^ n(s, 13) ^ n(s, 22), s & o ^ s & i ^ o & i), d = l, l = u, u = c, c = t(a, h), a = i, i = o, o = s, s = t(h, I);
