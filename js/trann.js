        ...
        ajax({
            ...
            success: function (res) {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    var domId = 'dom' + itemData.id;


                    if (val == '') {
                        time = "<div class='time'>" +
                            "<label class='layui-form-label'>传输范围:</label>" +
                    ...
                    if (siteType == 2) {
                        ...
                        tle = time + "<div class='type'>" + mInpt + hInpt + dInpt + "</div>";
                    } else {
                        var hInpt = h == 0 ? "<input type='checkbox' name='h' lay-skin='primary' title='小时数据'/>" : "<input type='checkbox' name='h' checked lay-skin='primary' title='小时数据'/>";
                        tle = time + "<div class='type'>" + hInpt + "</div>";
                    };
                    ...
                    for (var e = 0; e < itemData.element.length; e++) {
                        ...
                        if (elemData.checked == 0) {
                            str +=
                                '<div>' +
                                '<input type="checkbox" name="el" lay-skin="primary"  title="' + elemData.name + '" value="' + elemData.element + '"/>' +
                                '</div>'
                        } else {
                            str +=
                                '<div>' +
                                '<input type="checkbox" name="el" checked lay-skin="primary"  title="' + elemData.name + '" value="' + elemData.element + '"/>' +
                                '</div>';
                            num++
                        };
                    ...
                    checkStr += '<div class="item" id="' + itemData.id + '" type="' + itemData.type + '" >' + hide + cheAll + initv + tle + str + '</div>';
